    ...
    <div>
      <section style={{ background: '#0D0D0D', padding: '56px 0 40px', borderBottom: '3px solid #F5C400' }}>
        <div className="container">
          ...
          <span className="badge badge-yellow" style={{ marginBottom: 12 }}>Plagiarism Policy</span>
          ...
          <p style={{ color: '#aaa', fontSize: 15 }}>
            All manuscripts are checked for plagiarism before review.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 780 }}>
          <p style={{ fontSize: 16, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            Submissions containing significant copied content or improper citation may be rejected.
          </p>
          <p style={{ fontSize: 16, color: '#444', lineHeight: 1.8 }}>
            Authors should reference all sources clearly and avoid self-plagiarism.
          </p>
        </div>
      </section>
    </div>
