    ...
    <div>
      <section style={{ background: '#0D0D0D', padding: '56px 0 40px', borderBottom: '3px solid #F5C400' }}>
        <div className="container">
          ...
          <span className="badge badge-yellow" style={{ marginBottom: 12 }}>Aims & Scope</span>
          ...
          <p style={{ color: '#aaa', fontSize: 15 }}>
            The journal aims to publish quality research in science, engineering, and technology.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 780 }}>
          <p style={{ fontSize: 16, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            It welcomes research articles, reviews, and scholarly contributions from researchers worldwide.
          </p>
          <p style={{ fontSize: 16, color: '#444', lineHeight: 1.8 }}>
            Topics range across science, technology, applied engineering, and interdisciplinary innovation.
          </p>
        </div>
      </section>
    </div>
